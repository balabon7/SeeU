...
class MainAlarmViewController: UIViewController {
    ...
    //MARK: - В приложении на основе раскадровки вы часто захотите немного подготовиться перед навигацией
...
extension MainAlarmViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (cell == nil) {
            cell = UITableViewCell(style: UITableViewCell.CellStyle.subtitle, reuseIdentifier: Identifier.alarmCellIdentifier)
        }
        //cell text
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            alarmModel.alarms.remove(at: indexPath.row)
