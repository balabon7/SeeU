...
let dateOne =   DataForNotivication(timeToActive: "07:00", dateValue: DateComponents( hour: 15 , minute: 44), id: "FirstLocalNotification")
let dateTwo =   DataForNotivication(timeToActive: "09:30", dateValue: DateComponents( hour: 15 , minute: 45), id: "SecondLocalNotification")
let dateThree = DataForNotivication(timeToActive: "13:30", dateValue: DateComponents( hour: 15 , minute: 46), id: "ThirdLocalNotification")
